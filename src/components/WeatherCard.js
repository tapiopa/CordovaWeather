    ...
    render() {
        ...
        return (!this.props.city ? null :
            <Card style={styles.card} bg="success" text="white">
                <Card.Title> {city()} <i className="fas fa-trash-alt" style={styles.deleteIcon} onClick={() => deleteCity(this.props.city)}></i></Card.Title>
                ...
                <Card.Text style={styles.smallText} text="dark">{date()}</Card.Text>
            </Card>
        );
    }
}
